/* The twelve weekly themes and eighty-four daily prompts.
   Written for Pretty Amber. Edit freely — the app reads length from here,
...
export const WEEKS = [
  {
    ...
    prompts: [
      ...
      "What did you begin this year that you have already forgotten you began?",
  ...
  },
  {
    ...
    reflect: "Gratitude is not pretending things are fine. It is noticing what held while other things fell. Short lists still count.",
    ...
    prompts: [
      ...
      "What went right today that you had planned for, and what went right that you did not?",
      "Write a thank-you you have never said out loud.",
  ...
  },
  {
    ...
    prompts: [
      ...
      "What refills you that does not involve your phone?",
    ],
  },
  {
    hil: "Kaisog", en: "Courage",
    quote: "Brave is usually quiet, and usually early in the morning.",
    reflect: "Courage is rarely dramatic. It is the message you finally send, the price you name without apologising. Nobody claps. You just notice, afterward, that you did it.",
    ...
    prompts: [
      ...
      "What would change if you stopped apologising for taking up room?",
    ],
  },
  {
  ...
  },
  {
    ...
    prompts: [
      ...
      "Who do you feel most yourself around, and why them?",
  ...
  },
  {
    ...
    prompts: [
      ...
      "Where are you further along than you were, without noticing?",
    ],
  },
  {
    hil: "Kalipay", en: "Joy",
    ...
    prompts: [
      ...
      "What did you love doing at ten years old? Could you do a version of it now?",
  ...
  },
  {
    ...
    prompts: [
      ...
      "What would you tell someone facing what you faced two years ago?",
  ...
  },
  {
    ...
    prompts: [
      ...
      "Which corner of where you live do you love most, and why?",
