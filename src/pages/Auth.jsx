  ...
  return (
    <div className="shell">
      <div className="onboard narrow">
        <Link to="/" className="brand-mark link-plain">Pretty Amber</Link>
        ...
        <p className="fine" style={{ maxWidth: "28rem" }}>
          Your entries are readable only by your own account. Nobody else, including
          the page owner, can see what you write.
        </p>
      </div>
    </div>
  );
