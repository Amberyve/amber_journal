  ...
  return (
    <div>
        ...
        <div style={{ height: 220, marginTop: 8, marginLeft: -18 }}>
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={rows}>
              ...
              <XAxis dataKey="day" tick={{ fill: MUTED, fontSize: 11, fontFamily: "Karla" }}
                axisLine={{ stroke: RULE }} tickLine={false} />
              <YAxis domain={[0, 10]} ticks={[0, 5, 10]}
                tick={{ fill: MUTED, fontSize: 11, fontFamily: "Karla" }}
                axisLine={false} tickLine={false} />
              <Tooltip
                contentStyle={{ background: PAPER, border: `1px solid ${RULE}`, borderRadius: 4,
                  fontFamily: "Karla", fontSize: 12, color: INK }}
      ...
      <p className="fine" style={{ marginTop: 18 }}>
        ...
        harder to manage, that's worth talking through with a doctor or counsellor.
      </p>
    </div>
  );
}
